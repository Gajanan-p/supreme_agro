...
import com.bright.supreme.adapters.AllAgencyAdapter;
import com.bright.supreme.model.GetAllAgencyModel;

import java.util.ArrayList;

public class GetAllAgencyDialog extends Dialog {
    ...
    public GetAllAgencyDialog(@NonNull Context context, ArrayList<GetAllAgencyModel> allAgencyModels,
                              AgencyItemClickListener agencyItemClickListener) {
        super(context);
